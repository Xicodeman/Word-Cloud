...
def calculate_frequencies(file_contents):
    ...
    for word in file_contents:
        first_string =''.join(character for character in word if character.isalnum())
        if first_string.lower() not in uninteresting_words:            
            if first_string.lower() not in frequencies:
                frequencies[first_string.lower()] = 1
            else:
                frequencies[first_string.lower()] += 1 
